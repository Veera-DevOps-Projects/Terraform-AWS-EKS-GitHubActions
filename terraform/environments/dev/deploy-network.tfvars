...
parameters = ["/Terraform-AWS-EKS-GitHubActions/aws_region", "/Terraform-AWS-EKS-GitHubActions/business_division", "/Terraform-AWS-EKS-GitHubActions/environment",
  "/Terraform-AWS-EKS-GitHubActions/vpc_cidr_block", "/Terraform-AWS-EKS-GitHubActions/vpc_availability_zones", "/Terraform-AWS-EKS-GitHubActions/vpc_public_subnets",
